import{_ as s,o as n,c as e,a2 as t}from"./chunks/framework.BWuWLRhz.js";const g=JSON.parse('{"title":"Views","description":"","frontmatter":{},"headers":[],"relativePath":"features/views.md","filePath":"features/views.md"}'),l={name:"features/views.md"};function p(i,a,o,c,d,r){return n(),e("div",null,[...a[0]||(a[0]=[t(`<h1 id="views" tabindex="-1">Views <a class="header-anchor" href="#views" aria-label="Permalink to &quot;Views&quot;">​</a></h1><p>Volt templates untuk TAVP.</p><p><strong>Note:</strong> Volt di TAVP adalah compiled template engine. Bukan <a href="https://laravel.com/docs/volt" target="_blank" rel="noreferrer">Laravel Volt</a> yang Livewire-based.</p><h2 id="basic-views" tabindex="-1">Basic Views <a class="header-anchor" href="#basic-views" aria-label="Permalink to &quot;Basic Views&quot;">​</a></h2><div class="language-volt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">volt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;!DOCTYPE html&gt;</span></span>
...
<span class="line"><span>{{ date | date(&#39;Y-m-d&#39;) }}</span></span></code></pre></div><h2 id="link" tabindex="-1">Link <a class="header-anchor" href="#link" aria-label="Permalink to &quot;Link&quot;">​</a></h2><ul><li><a href="/features/routing.html">Routing</a></li></ul>`,17)])])}const u=s(l,[["render",p]]);export{g as __pageData,u as default};
