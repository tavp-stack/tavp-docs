...
This tutorial will guide you through building your first TAVP application.
...
Create `resources/views/posts/index.volt`:
...
Open [http://localhost:8000/posts](http://localhost:8000/posts)

## Next

- [Project Structure](/en/guide/project-structure)
- [ORM Guide](/en/features/orm)
